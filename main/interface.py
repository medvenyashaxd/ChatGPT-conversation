...
class ChatGPTFrame(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.out_box = customtkinter.CTkTextbox(self, height=610, corner_radius=10, text_color='#ffffff',
                                                state='normal')
        self.out_box.grid(row=0, column=1, padx=(5, 5), pady=(5, 0), sticky="nsew")

        self.input_box = customtkinter.CTkTextbox(self, height=125, corner_radius=10, text_color='#eeeee4')
...
class App(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        self.title('ChatGPT')
        self.logo = customtkinter.CTkImage(Image.open('../icon/GPT.ico'))
